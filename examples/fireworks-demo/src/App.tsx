    ...
    <div className="h-screen flex flex-col bg-[#0a0a0f] text-white font-sans">
      ...
      <header className="flex items-center justify-between px-5 py-3 border-b border-white/[0.07] bg-[#0a0a0f]/80 backdrop-blur flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-orange-500/15 text-orange-400 border border-orange-500/25">
            @yourgpt/llm-sdk/fireworks
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          {models.length > 0 && (
            <select
              ...
              className="text-xs bg-white/[0.06] border border-white/[0.1] rounded-md px-3 py-1.5 text-white/80 focus:outline-none focus:border-orange-500/50 cursor-pointer"
            >
              {models.map((m) => (
          ...
          <a
            ...
            className="text-[11px] text-orange-400/70 hover:text-orange-400 transition-colors whitespace-nowrap"
          >
            Browse models ↗
          </a>
        </div>
