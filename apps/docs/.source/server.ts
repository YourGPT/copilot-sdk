...
import { default as __fd_glob_8 } from "../content/docs/tools/meta.json?collection=docs";
...
import * as __fd_glob_4 from "../content/docs/tools/index.mdx?collection=docs";
import * as __fd_glob_3 from "../content/docs/runtime/index.mdx?collection=docs";
...
export const docs = await create.docs(
  ...
  },
  {
    ...
    "runtime/index.mdx": __fd_glob_3,
    "tools/index.mdx": __fd_glob_4,
    "ui/index.mdx": __fd_glob_5,
    "react/index.mdx": __fd_glob_6,
  },
);
