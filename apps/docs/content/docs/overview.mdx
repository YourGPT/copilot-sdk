...
| [**Frontend Tools**](/docs/tools/frontend-tools) | Give AI abilities in your app |
| [**Generative UI**](/docs/generative-ui) | Render React components as tool results |
| [**Smart AI Context**](/docs/skills) | AI understands your app state |
...
- [Getting Started](/docs/getting-started) - 5 minute setup
- [Chat](/docs/chat) - Chat component docs
- [Frontend Tools](/docs/tools/frontend-tools) - Build AI capabilities
