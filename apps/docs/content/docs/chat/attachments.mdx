...
- [Streaming](/docs/llm-sdk/stream-text) - Real-time responses
- [AI Context](/docs/skills) - Provide app context
- [Custom Tools](/docs/tools/frontend-tools) - Build tools that use attachments
