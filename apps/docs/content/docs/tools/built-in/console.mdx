...
- [Screenshot Tool](/docs/tools/built-in/screenshot) - Capture visual context
- [Tool Approval](/docs/tools/frontend-tools) - Approval flow details
- [Custom Tools](/docs/tools/frontend-tools) - Build more debugging tools
