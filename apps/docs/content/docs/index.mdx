...
<Tabs items={['npm', 'pnpm', 'bun']}>
  <Tab value="npm">
    ```bash
    npm install @yourgpt/copilot-sdk-react @yourgpt/copilot-sdk-ui @yourgpt/copilot-sdk-runtime
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @yourgpt/copilot-sdk-react @yourgpt/copilot-sdk-ui @yourgpt/copilot-sdk-runtime
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @yourgpt/copilot-sdk-react @yourgpt/copilot-sdk-ui @yourgpt/copilot-sdk-runtime
    ```
  </Tab>
</Tabs>
...
<Cards>
  <Card title="Installation" href="/docs/installation" icon="📦">
    Full setup guide with Next.js, Vite, and more
  </Card>
  <Card title="React Hooks" href="/docs/react" icon="⚛️">
    useAIChat, useToolWithSchema, useAIContext, and more
  </Card>
  <Card title="UI Components" href="/docs/ui" icon="🎨">
    CopilotChat, DevLogger, and primitives
  </Card>
  <Card title="Custom Tools" href="/docs/tools" icon="🔧">
    Build tools that do anything
  </Card>
  <Card title="Message Persistence" href="/docs/message-persistence" icon="💾">
    Database storage, sync patterns, and tool call handling
  </Card>
</Cards>
