...
<div className="not-prose mb-8 rounded-xl overflow-hidden border bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5">
  <div className="aspect-[21/9] flex items-center justify-center">
    <div className="text-center">
      <div className="text-6xl mb-4">🤖</div>
      <p className="text-muted-foreground">Hero image / Demo GIF placeholder</p>
    </div>
  </div>
</div>
...
<Cards>
  <Card title="Why Copilot SDK" href="/docs/why-copilot-sdk" icon="✨">
