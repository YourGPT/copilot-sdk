...
<Tabs items={['MCP360 Gateway', 'OAuth Headers', 'Custom Headers']}>
  <Tab value="MCP360 Gateway">
    ...
    **Includes:** [Web search](https://mcp360.ai/mcps/google-search), [scraping](https://mcp360.ai/mcps/web-scraping), SEO tools, e-commerce data, and more.
    ...
    Best for: Teams wanting multiple integrations through a single token
  </Tab>
  <Tab value="OAuth Headers">
    OAuth 2.1 style authentication using Authorization headers.
    ...
    ```
    Best for: OAuth-enabled services (Figma, GitHub, Slack, etc.)
  </Tab>
  <Tab value="Custom Headers">
    ...
    ```
    Best for: Custom MCP servers with API key authentication
  </Tab>
</Tabs>
